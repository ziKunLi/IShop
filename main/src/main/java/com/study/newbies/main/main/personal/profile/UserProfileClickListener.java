...
import com.study.newbies.common.view.DateDialogUtil;
                ...
                CallbackManager.getInstance()
                        .addCallback(CallbackType.ON_CROP, new IGlobalCallback<Uri>() {
                            ...
                            public void executeCallback(Uri args) {
                                final ImageView avatar = (ImageView) view.findViewById(R.id.imgArrowAvatar);
                                Glide.with(DELEGATE)
                                        .load(args)
                                        .into(avatar);
...
//                DELEGATE.startCameraWithCheck();
                break;
            case 2:
                final AppDelegate nameDelegate = bean.getDelegate();
            ...
            case 3:
                getGenderDialog(new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        final TextView textView = (TextView) view.findViewById(R.id.tvArrowValue);
